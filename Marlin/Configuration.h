...
#define CUSTOM_MACHINE_NAME "Pursotin i3 rework"
 ...
 */
#define TEMP_SENSOR_0 1   // 1 Ei tiiä
 ...
 */
//#define PIDTEMPBED  //oli kyllä päällä
...
#define X_MIN_ENDSTOP_INVERTING false  // Set to true to invert the logic of the endstop. //true
#define Y_MIN_ENDSTOP_INVERTING false  // Set to true to invert the logic of the endstop.  //törmäilleessssää
