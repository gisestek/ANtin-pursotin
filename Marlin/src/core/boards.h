...
#define _MB_1(B) (defined(BOARD_##B) && MOTHERBOARD==BOARD_##B)  //poistettu yksi välilyönrti ...ennen (defined)
#define MB(V...) DO(MB,||,V) //poistettu yksi välilyönrti ...ennen DO(MB
